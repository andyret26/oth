...
export default function ShowTeamBox({ t }: CompProps) {
  return (
    <div
      id="team-mates"
      className="z-50 bg-[#4e3c44]/95 flex flex-wrap gap-x-7 gap-y-2 justify-center w-72 absolute top-[120px] rounded-md p-2 animate__animated animate__fadeIn animate__faster"
    >
      {t.teamMates.map((tm) => (
